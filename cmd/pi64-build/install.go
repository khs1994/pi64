...
func installDebian() error {
	...
	aptSources := []byte(`
deb http://cdn-fastly.deb.debian.org/debian sid main contrib non-free
deb-src http://cdn-fastly.deb.debian.org/debian sid main contrib non-free

deb http://cdn-fastly.deb.debian.org/debian sid-updates main contrib non-free
deb-src http://cdn-fastly.deb.debian.org/debian sid-updates main contrib non-free

deb http://cdn-fastly.deb.debian.org/debian-security sid/updates main contrib non-free
deb-src http://cdn-fastly.deb.debian.org/debian-security sid/updates main contrib non-free
`)
